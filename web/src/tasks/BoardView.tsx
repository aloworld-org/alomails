          ...
          >
            ...
            {cards.map((t) => {
              ...
              return (
                <div
                  key={t.id}
                  className={`flex cursor-pointer flex-col gap-3 rounded-2xl border border-subtle bg-surface p-4 shadow-sm transition-[border-color,box-shadow,opacity] hover:border-default hover:shadow-md ${
