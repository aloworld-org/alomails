          ...
          return (
            <div key={t.id} className="relative isolate flex border-b border-subtle last:border-b-0" style={{ height: ROW }}>
              ...
              <div className="relative h-full overflow-hidden" style={{ width: total }}>
                <button
                  type="button"
                  className="absolute top-4 z-0 h-5 overflow-hidden rounded-full border shadow-sm transition-[filter,border-color] hover:brightness-95 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent focus-visible:ring-offset-2"
                  style={{
                    left,
                    width,
                    minWidth: 18,
