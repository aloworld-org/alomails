...
const rowClass = "flex min-h-11 w-full items-center gap-2 rounded-md border-0 bg-transparent px-3 text-left text-sm text-primary hover:bg-raised focus-visible:outline-2 focus-visible:outline-accent";
