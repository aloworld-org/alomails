...
const rowClass = "flex min-h-9 w-full items-center gap-2.5 rounded-md border border-transparent bg-transparent px-2 text-left text-sm text-primary transition-colors duration-150 hover:bg-raised focus-visible:outline-2 focus-visible:outline-accent";
