...
export function MessageFeed({ room, messages, feedRef, moreBehind, loadingOlder, readUpTo, palette, me, onOlder, onReact, onOpenFile, onDecide, onEdit, onWithdraw, onReplyHere, onReplyPrivate }: Props) {
  return <div className="flex min-h-0 flex-1 flex-col overflow-y-auto px-4 pb-4" ref={feedRef}>
    {!moreBehind && messages !== null && <div className="mx-auto my-8 w-full max-w-3xl rounded-xl border border-subtle bg-surface p-5">
