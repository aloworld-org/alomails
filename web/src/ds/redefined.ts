...
export const REDEFINES_PRIMITIVES: readonly string[] = [
  ...
  "authoring/CrossReference.module.css",
  "authoring/EquationEditor.module.css",
  "authoring/HeadingBlock.module.css",
  "authoring/ParagraphBlock.module.css",
  "authoring/TableBlock.module.css",
  "billing/BillingModule.module.css",
  "chat/ChatModule.module.css",
  "contacts/ContactsModal.module.css",
  "crm/CrmModule.module.css",
  "drive/BaseEditor.module.css",
  "drive/DriveModule.module.css",
  "drive/docBlocks.module.css",
  ...
  "mail/components/ComposeModal.module.css",
  "mail/components/FlagDueControl.module.css",
  "mail/components/InvitationCard.module.css",
  "mail/components/ReadingPane.module.css",
  "mail/components/RecipientInput.module.css",
  "mail/components/RichTextEditor.module.css",
  "mail/components/SnoozeMenu.module.css",
