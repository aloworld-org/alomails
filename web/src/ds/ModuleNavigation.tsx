...
const itemBase =
  "inline-flex min-h-11 shrink-0 cursor-pointer items-center gap-2.5 rounded-xl border-0 px-4 py-2.5 text-sm !no-underline transition-colors hover:!no-underline focus-visible:!no-underline focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-accent";
