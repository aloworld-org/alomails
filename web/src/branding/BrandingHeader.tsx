...
export function BrandingHeader({ brand }: { brand: BrandKitController }) {
  ...
  return (
    <header className="shrink-0 border-b border-subtle bg-header px-4 py-5 sm:px-6 lg:px-8 print:hidden">
      <div className="mx-auto flex w-full max-w-[94rem] flex-wrap items-center justify-between gap-5">
        <div className="flex min-w-0 items-center gap-3.5">
          ...
          <div className="min-w-0">
            ...
            <p className="mb-0 mt-1 max-w-3xl text-sm leading-5 text-secondary">
        ...
        <div className="flex min-h-control items-center gap-3">
          <span
            className={`inline-flex max-w-sm items-center justify-end gap-1 text-xs ${brand.saveFailed ? "text-danger" : brand.savedNotice ? "text-success" : "text-tertiary"}`}
            role="status"
            aria-live="polite"
          >
