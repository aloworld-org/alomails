...
export const en = {
  ...
  sitesThemeSubtitle: "Choose a starting style, set your brand colors, and add your logo.",
  sitesThemeApply: "Apply theme",
  sitesThemeLoadFailed: "The theme options could not be loaded.",
  sitesThemePresets: "Colors & type",
  sitesThemeBrandColors: "Brand colors",
  sitesThemeBrandColorsHint: "Set these once, then reuse the named colors in navigation and page sections.",
