...
export const en = {
  ...
  chatSend: "Send",
  chatEdited: "edited",
  chatSourceOne: "Answered from 1 source",
  chatSourceCount: "Answered from {count} sources",
  chatSourceEmail: "email",
  chatSourceChat: "chat message",
  chatSourceEvent: "calendar event",
  chatSourceRemembered: "remembered here",
  ...
  crmMailOpportunityTitle: "Create opportunity from email",
  crmMailOpportunitySubtitle:
    "Review the sales details. The complete conversation stays linked to the opportunity.",
  crmMailOpportunityConfirm: "Create opportunity",
  crmMailOpportunityLoadFailed: "The sales boards could not be loaded.",
  crmMailOpportunityCreateFailed: "The opportunity could not be created.",
  crmMailConversation: "Source conversation",
  crmMailSource: "Email",
  crmChoosePipeline: "Choose a pipeline",
  crmChooseStage: "Choose a stage",
  crmOpportunityCreated: "Opportunity created and conversation linked.",
  ...
  crmReportCustom: "Custom range",
  crmReportQuickRanges: "Quick ranges",
  crmReportToday: "Today",
  crmReportYesterday: "Yesterday",
  crmReportLast7Days: "Last 7 days",
  crmReportLast28Days: "Last 28 days",
  crmReportLast30Days: "Last 30 days",
  crmReportApply: "Apply",
  ...
  crmReportClosedDeals: "closed deals",
  ...
  sitesColPath: "Path",
  sitesColSeo: "Search",
  sitesColAccess: "Access",
  sitesSearchPages: "Search pages",
  sitesPageFilter: "Page filter",
  sitesFilterAllPages: "All",
  sitesFilterHomePage: "Homepage",
  sitesFilterProtectedPages: "Protected",
  sitesSeoReady: "Ready",
  sitesSeoNeedsWork: "Needs work",
  sitesPublicPage: "Public",
  sitesNoMatchingPages: "No pages match this view.",
  sitesSortPages: "Sort",
  ...
  sitesDomainHealthy: "Domain ready",
  sitesNotPublishedYet: "Not published yet",
  sitesLastPublished: (date: string) => `Last published: ${date}`,
  sitesLastEdited: (date: string) => `Updated ${date}`,
  ...
  sitesLanguagesHint:
    "Choose the content languages for this website. This does not change an editor's alo language.",
  sitesDefaultLanguage: "Default language",
  sitesAddLanguage: "Add a language",
  sitesLanguagePlaceholder: "Language code, for example zh-Hans",
  ...
  sitesSectionTransitionDesc: "Motion between this section and the next.",
  sitesTransitionSummary: "Animates the next section on scroll",
  sitesTransitionStyle: "Transition style",
  sitesTransitionStyleHint:
    "Choose how the next section enters the page. The diagram shows the movement, not a fake content preview.",
  sitesTransitionFade: "Soft fade",
  sitesTransitionSlide: "Slide",
  sitesTransitionScale: "Scale in",
  sitesTransitionReveal: "Reveal",
  sitesTransitionDirection: "Direction",
  sitesTransitionUp: "From below",
  sitesTransitionDown: "From above",
  sitesTransitionLeft: "From right",
  sitesTransitionRight: "From left",
  sitesTransitionTiming: "Timing",
  sitesTransitionTrigger: "Starts when",
  sitesTransitionEarly: "Entering view",
  sitesTransitionBalanced: "Partly visible",
  sitesTransitionLate: "Mostly visible",
  sitesTransitionAnimateOut: "Animate out when leaving",
  sitesTransitionAnimateOutHint:
    "Turn this on for storytelling pages. Leave it off when visitors need to scan quickly.",
  ...
  sitesFeaturesLayoutSteps: "Numbered steps",
  sitesFeaturesLayoutSpotlight: "First feature",
  ...
  sitesTextImageLayoutEditorial: "Editorial",
  sitesTextImageLayoutFullBleed: "Full bleed",
  ...
  sitesGalleryLayoutSpotlight: "Spotlight",
  ...
  sitesTestimonialsLayoutStacked: "Stacked stories",
  sitesTestimonialsLayoutCarousel: "Carousel",
  ...
  sitesPricingLayoutCompact: "Compact rows",
  sitesPricingLayoutEditorial: "Editorial",
  sitesSectionTeam: "Team",
  sitesSectionTeamDesc: "The people behind the business.",
  sitesTeamLayout: "Team layout",
  sitesTeamLayoutHint: "Choose how people and their stories appear together.",
  sitesTeamLayoutPortraits: "Portrait grid",
  sitesTeamLayoutCards: "Profile cards",
  sitesTeamLayoutRoster: "Team roster",
  sitesTeamLayoutSpotlight: "Leader spotlight",
  sitesTeamLayoutCompact: "Compact list",
  sitesSectionFaq: "FAQ",
  sitesSectionFaqDesc: "Questions people ask, answered.",
  sitesFaqLayout: "FAQ layout",
  sitesFaqLayoutHint: "Choose how visitors scan and open your answers.",
  sitesFaqLayoutAccordion: "Accordion",
  sitesFaqLayoutDivided: "Divided list",
  sitesFaqLayoutCards: "Answer cards",
  sitesFaqLayoutTwoColumn: "Two columns",
  sitesFaqLayoutEditorial: "Editorial",
  sitesSectionCta: "Call to action",
  sitesSectionCtaDesc: "A banner that asks for the click.",
  sitesCtaLayout: "Call to action layout",
  sitesCtaLayoutHint: "Choose the emphasis and number of actions this moment needs.",
  sitesCtaLayoutCentered: "Centered",
  sitesCtaLayoutSplit: "Split",
  sitesCtaLayoutBanner: "Full banner",
  sitesCtaLayoutCard: "Floating card",
  ...
  sitesNavDestination: "Page or section",
  sitesNavPages: "Pages",
  ...
  sitesNavPaletteTheme: "Site theme",
  ...
  sitesNavText: "Text",
  sitesNavHover: "Hover",
  sitesNavPreviewBrand: "Your brand",
  sitesNavPreviewLink: "Menu link",
  sitesNavPreviewHover: "Hover state",
  sitesNavContrastPass: "Text and hover colours meet WCAG AA contrast.",
  sitesNavContrastFail: "Choose colours with at least 4.5:1 contrast.",
  ...
  sitesHeroColors: "Colors",
  sitesHeroColorsHint:
    "Choose reusable colors from the Site theme. Button text stays readable automatically.",
  sitesHeroBackgroundColor: "Hero background",
  sitesHeroButtonLayout: "Buttons",
  sitesHeroNoButtons: "No buttons",
  sitesHeroOneButton: "One button",
  sitesHeroTwoButtons: "Two buttons",
  sitesHeroPrimaryButtonColor: "Primary button",
  sitesHeroPrimaryButtonText: "Primary button text",
  sitesHeroPrimaryButtonHover: "Primary button hover",
  sitesHeroPrimaryButtonHoverText: "Primary hover text",
  sitesHeroSecondaryButtonColor: "Secondary button",
  sitesHeroSecondaryButtonText: "Secondary button text",
  sitesHeroSecondaryButtonHover: "Secondary button hover",
  sitesHeroSecondaryButtonHoverText: "Secondary hover text",
  sitesHeroHoverBackground: "Hover background",
  sitesHeroHoverText: "Hover text",
  sitesHeroAutomaticContrast: "Automatic contrast",
  sitesHeroButtonContrastWarning:
    "This button color combination is difficult to read. Choose colors with stronger contrast.",
  sitesHeroUseThemeColors: "Use theme defaults",
  sitesHeroAnimation: "Animation",
  sitesHeroAnimationHint:
    "Add calm entrance motion to the words and media. Visitors who prefer reduced motion always see a still version.",
  sitesHeroTextAnimation: "Words",
  sitesHeroMediaAnimation: "Image or video",
  sitesHeroAnimationNone: "None",
  sitesHeroTextFadeUp: "Fade up",
  sitesHeroTextWordReveal: "Word reveal",
  sitesHeroTextSlideIn: "Slide in",
  sitesHeroMediaFadeIn: "Fade in",
  sitesHeroMediaSlideUp: "Slide up",
  sitesHeroMediaSlowZoom: "Slow zoom",
  sitesHeroAnimationSpeed: "Pace",
  sitesHeroAnimationQuick: "Quick",
  ...
  sitesThemeBackgroundColor: "Background",
  ...
  brandingSupportingName: (number: number) => `Supporting ${number}`,
  brandingRemoveColor: (name: string) => `Remove ${name}`,
  brandingMoveColorUp: (name: string) => `Move ${name} up`,
  brandingMoveColorDown: (name: string) => `Move ${name} down`,
  brandingInvalidColor: "Give every color a name and a six-digit HEX value.",
  ...
  brandingSeeItInUse: "See your colors in real work",
  brandingPreviewContexts: "Brand preview contexts",
  brandingPreviewWebsite: "Website",
  brandingPreviewDocument: "Quote & invoice",
  brandingPreviewCampaign: "Campaign",
  brandingToneScale: "Primary color scale",
  brandingGenerated: "Derived from Primary",
  brandingCopyColor: (color: string) => `Copy ${color}`,
  ...
  brandingGuidanceSupporting: "0–2 supporting — typical; up to 3 available",
  brandingWcagAa: "WCAG AA",
  brandingBalanceRatio: "70 / 20 / 10",
  brandingNavLabel: "Branding areas",
  brandingFoundationNav: "Brand foundation",
  ...
  brandingTaglineHint: "A short promise or idea people should remember.",
  brandingTaglinePlaceholder: "Write a concise brand promise",
  brandingPurpose: "Purpose",
  ...
  brandingLogoReplace: "Replace logo",
  brandingLogoRemove: "Remove logo",
  brandingLogoRequirements: "SVG, PNG, JPEG, or WebP · maximum 500 KB",
  ...
  brandingGuidelineColors: "Colour roles",
  brandingGuidelineTypography: "Typography",
  ...
  brandingPreviewWork: "Work",
  brandingPreviewAbout: "About",
  ...
  brandingPreviewCountries: "countries",
  brandingPreviewReferred: "referred",
  brandingPreviewQuoteLabel: "QUOTATION",
  brandingPreviewPreparedFor: "Prepared for",
  brandingPreviewQuote: "Quote",
  brandingPreviewBrandStrategy: "Brand strategy",
  ...
  projectsSetupFailed: "The selected project resources could not be created.",
  projectsSetupLoadFailed: "Project resources could not be loaded.",
  projectsFiles: "Project files",
  projectsChatRoom: "Project chat",
  projectsKickoffMeeting: "Kickoff meeting",
  projectsStarterTasks: (count: number) => `${count} starter tasks`,
  ...
  financeReadyToPay: "Approved employee expenses to pay",
  ...
  financeForecastOptimistic: "Optimistic",
  financeForecastHorizon: "Forecast window",
  financeForecast30Days: "Next 30 days",
  financeForecast60Days: "Next 60 days",
  ...
  financeForecastNet: "Net movement",
  financeForecastBalance: "Projected balance",
  ...
  financeLastQuarter: "Last quarter",
  financeActiveEngagements: "Active engagements",
  ...
  financePolicyTitle: "Spend controls",
  financePolicySubtitle:
    "Set the evidence and approval requirements the server enforces before a claim can enter the books.",
  financePolicyLoadFailed: "Spend controls could not be loaded.",
  financePolicySaveFailed: "Spend controls could not be saved.",
  financePolicyRules: "Expense policy",
  financePolicyRulesHint: (currency: string) =>
    `Thresholds are stated in the accounting currency, ${currency}.`,
  financeReceiptRule: "Require a receipt",
  financeReceiptRuleHint:
    "Claims at or above this amount cannot be approved without an attached receipt.",
  financeProjectRule: "Require a project",
  financeProjectRuleHint:
    "Claims at or above this amount must be assigned to an engagement before approval.",
  financeSecondApprovalRule: "Require two approvers",
  financeSecondApprovalRuleHint:
    "High-value claims stay submitted until two different finance approvers agree.",
  financePolicyEnabled: "Enabled",
  financePolicyDisabled: "Disabled",
  financePolicySaved: "Controls saved",
  financeSaving: "Saving…",
  financeSavePolicy: "Save controls",
  financeApprovalRecorded: (count: number, required: number) =>
    `Approval ${count} of ${required} recorded. A different approver must complete this claim.`,
  ...
  financeLockedThrough: (date: string) => `Books locked through ${date}`,
  financeBooksOpen: "Books are open",
  ...
  financeCloseReceivableFx: "Receivable FX",
  financeClosePayableFx: "Payable FX",
  ...
  financeOpen: "Open",
  financeClosedAt: (date: string) => `Closed ${date}`,
  ...
  billingCustomizeInvoice: "Customize invoice",
  billingInvoiceLabel: "Invoice",
