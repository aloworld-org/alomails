...
export const en = {
  ...
  financePolicySubtitle: "Set the evidence and approval requirements the server enforces before a claim can enter the books.",
  ...
  financePolicyRulesHint: (currency: string) => `Thresholds are stated in the accounting currency, ${currency}.`,
  financeReceiptRule: "Require a receipt",
  financeReceiptRuleHint: "Claims at or above this amount cannot be approved without an attached receipt.",
  financeProjectRule: "Require a project",
  financeProjectRuleHint: "Claims at or above this amount must be assigned to an engagement before approval.",
  financeSecondApprovalRule: "Require two approvers",
  financeSecondApprovalRuleHint: "High-value claims stay submitted until two different finance approvers agree.",
  ...
  financeApprovalRecorded: (count: number, required: number) => `Approval ${count} of ${required} recorded. A different approver must complete this claim.`,
  financeApprovalProgress: (count: number, required: number) => `${count} of ${required} approvals`,
