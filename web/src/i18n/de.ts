...
export const de: Partial<Catalog> = {
  ...
  financePolicySubtitle: "Legen Sie Nachweis- und Freigaberegeln fest, die der Server vor der Buchung durchsetzt.",
  financePolicyLoadFailed: "Die Ausgabenkontrollen konnten nicht geladen werden.",
  financePolicySaveFailed: "Die Ausgabenkontrollen konnten nicht gespeichert werden.",
  financePolicyRules: "Ausgabenrichtlinie",
  financePolicyRulesHint: (currency: string) => `Schwellenwerte gelten in der Buchungswährung ${currency}.`,
  financeReceiptRule: "Beleg verlangen",
  financeReceiptRuleHint: "Ausgaben ab diesem Betrag können ohne angehängten Beleg nicht freigegeben werden.",
  financeProjectRule: "Projekt verlangen",
  financeProjectRuleHint: "Ausgaben ab diesem Betrag müssen vor der Freigabe einem Auftrag zugeordnet sein.",
  financeSecondApprovalRule: "Zwei Freigaben verlangen",
  financeSecondApprovalRuleHint: "Hochwertige Ausgaben bleiben eingereicht, bis zwei verschiedene Finanzprüfer zustimmen.",
  ...
  financeApprovalRecorded: (count: number, required: number) => `Freigabe ${count} von ${required} erfasst. Eine andere Person muss abschließen.`,
  financeApprovalProgress: (count: number, required: number) => `${count} von ${required} Freigaben`,
