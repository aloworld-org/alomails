...
export const de: Partial<Catalog> = {
  ...
  financeForecastHorizon: "Prognosezeitraum",
  financeForecast30Days: "Nächste 30 Tage",
  financeForecast60Days: "Nächste 60 Tage",
  ...
  financeForecastNet: "Nettoveränderung",
  financeForecastBalance: "Prognosesaldo",
  ...
  financeActiveEngagements: "Aktive Aufträge",
  ...
  financePolicyTitle: "Ausgabenkontrollen",
  financePolicySubtitle:
    "Legen Sie Nachweis- und Freigaberegeln fest, die der Server vor der Buchung durchsetzt.",
  financePolicyLoadFailed:
    "Die Ausgabenkontrollen konnten nicht geladen werden.",
  financePolicySaveFailed:
    "Die Ausgabenkontrollen konnten nicht gespeichert werden.",
  financePolicyRules: "Ausgabenrichtlinie",
  financePolicyRulesHint: (currency: string) =>
    `Schwellenwerte gelten in der Buchungswährung ${currency}.`,
  financeReceiptRule: "Beleg verlangen",
  financeReceiptRuleHint:
    "Ausgaben ab diesem Betrag können ohne angehängten Beleg nicht freigegeben werden.",
  financeProjectRule: "Projekt verlangen",
  financeProjectRuleHint:
    "Ausgaben ab diesem Betrag müssen vor der Freigabe einem Auftrag zugeordnet sein.",
  financeSecondApprovalRule: "Zwei Freigaben verlangen",
  financeSecondApprovalRuleHint:
    "Hochwertige Ausgaben bleiben eingereicht, bis zwei verschiedene Finanzprüfer zustimmen.",
  financePolicyEnabled: "Aktiv",
  financePolicyDisabled: "Inaktiv",
  financePolicySaved: "Kontrollen gespeichert",
  financeSaving: "Speichern…",
  financeSavePolicy: "Kontrollen speichern",
  financeApprovalRecorded: (count: number, required: number) =>
    `Freigabe ${count} von ${required} erfasst. Eine andere Person muss abschließen.`,
  financeApprovalProgress: (count: number, required: number) =>
    `${count} von ${required} Freigaben`,
  ...
  sitesTransitionReveal: "Enthüllen",
  sitesTransitionDirection: "Richtung",
  sitesTransitionUp: "Von unten",
  sitesTransitionDown: "Von oben",
  sitesTransitionLeft: "Von rechts",
  sitesTransitionRight: "Von links",
  sitesTransitionTiming: "Timing",
  sitesTransitionTrigger: "Startet wenn",
  sitesTransitionEarly: "Im Sichtfeld",
  ...
  sitesFeaturesLayoutSteps: "Nummerierte Schritte",
  sitesFeaturesLayoutSpotlight: "Erstes hervorheben",
  ...
  sitesTextImageLayoutEditorial: "Redaktionell",
  sitesTextImageLayoutFullBleed: "Vollflächig",
  ...
  sitesGalleryLayoutFilmstrip: "Filmstreifen",
  sitesGalleryLayoutSpotlight: "Blickfang",
  ...
  sitesTestimonialsLayoutStacked: "Gestapelte Geschichten",
  sitesTestimonialsLayoutCarousel: "Karussell",
  ...
  sitesPricingLayoutCompact: "Kompakte Zeilen",
  ...
  sitesTeamLayoutSpotlight: "Leitung im Fokus",
  sitesTeamLayoutCompact: "Kompakte Liste",
  sitesSectionFaq: "FAQ",
  sitesSectionFaqDesc: "Fragen, die gestellt werden — beantwortet.",
  sitesFaqLayout: "FAQ-Layout",
  sitesFaqLayoutHint: "Wähle, wie Besucher Antworten überblicken und öffnen.",
  sitesFaqLayoutAccordion: "Akkordeon",
  sitesFaqLayoutDivided: "Geteilte Liste",
  sitesFaqLayoutCards: "Antwortkarten",
  sitesFaqLayoutTwoColumn: "Zwei Spalten",
  sitesFaqLayoutEditorial: "Editorial",
  sitesSectionCta: "Handlungsaufruf",
  sitesSectionCtaDesc: "Ein Banner, das um den Klick bittet.",
  sitesCtaLayout: "CTA-Layout",
  sitesCtaLayoutHint: "Wähle Betonung und Anzahl der Aktionen für diesen Moment.",
  sitesCtaLayoutCentered: "Zentriert",
  sitesCtaLayoutSplit: "Geteilt",
  sitesCtaLayoutBanner: "Volles Banner",
  sitesCtaLayoutCard: "Schwebende Karte",
  ...
  sitesHeroColors: "Farben",
  sitesHeroColorsHint:
    "Wählen Sie wiederverwendbare Farben aus dem Website-Theme. Schaltflächentext bleibt automatisch lesbar.",
  sitesHeroBackgroundColor: "Hero-Hintergrund",
  sitesHeroButtonLayout: "Schaltflächen",
  sitesHeroNoButtons: "Keine Schaltflächen",
  sitesHeroOneButton: "Eine Schaltfläche",
  sitesHeroTwoButtons: "Zwei Schaltflächen",
  sitesHeroPrimaryButtonColor: "Primäre Schaltfläche",
  sitesHeroPrimaryButtonText: "Text der primären Schaltfläche",
  sitesHeroPrimaryButtonHover: "Primäre Schaltfläche bei Hover",
  sitesHeroPrimaryButtonHoverText: "Primärer Hover-Text",
  sitesHeroSecondaryButtonColor: "Sekundäre Schaltfläche",
  sitesHeroSecondaryButtonText: "Text der sekundären Schaltfläche",
  sitesHeroSecondaryButtonHover: "Sekundäre Schaltfläche bei Hover",
  sitesHeroSecondaryButtonHoverText: "Sekundärer Hover-Text",
  sitesHeroHoverBackground: "Hover-Hintergrund",
  sitesHeroHoverText: "Hover-Text",
  sitesHeroAutomaticContrast: "Automatischer Kontrast",
  sitesHeroButtonContrastWarning:
    "Diese Farbkombination ist schwer lesbar. Wählen Sie Farben mit stärkerem Kontrast.",
  sitesHeroUseThemeColors: "Theme-Standardwerte verwenden",
  sitesHeroAnimation: "Animation",
  sitesHeroAnimationHint:
    "Fügen Sie Wörtern und Medien eine ruhige Eingangsbewegung hinzu. Bei reduzierter Bewegung wird immer eine unbewegte Version gezeigt.",
  sitesHeroTextAnimation: "Wörter",
  sitesHeroMediaAnimation: "Bild oder Video",
  sitesHeroAnimationNone: "Keine",
  sitesHeroTextFadeUp: "Nach oben einblenden",
  sitesHeroTextWordReveal: "Wörter enthüllen",
  sitesHeroTextSlideIn: "Hereingleiten",
  sitesHeroMediaFadeIn: "Einblenden",
  sitesHeroMediaSlideUp: "Nach oben gleiten",
  sitesHeroMediaSlowZoom: "Langsamer Zoom",
  sitesHeroAnimationSpeed: "Tempo",
  sitesHeroAnimationQuick: "Schnell",
  ...
  sitesCatalogLayout: "Katalog-Layout",
  sitesCatalogLayoutHint: "Wähle, wie Besucher Artikel, Details und Preise vergleichen.",
  sitesCatalogLayoutGrid: "Produktraster",
  sitesCatalogLayoutMenu: "Preismenü",
  sitesCatalogLayoutList: "Detaillierte Liste",
  sitesCatalogLayoutFeatured: "Hervorgehobener Artikel",
  sitesCatalogLayoutCompact: "Kompaktes Raster",
