...
export const de: Partial<Catalog> = {
  ...
  sitesWebsiteNavigation: "Website-Arbeitsbereich",
  ...
  sitesThemeSubtitle: "Wählen Sie einen Ausgangsstil, legen Sie Ihre Markenfarben fest und fügen Sie Ihr Logo hinzu.",
  ...
  sitesThemeBrandColors: "Markenfarben",
  sitesThemeBrandColorsHint: "Einmal festlegen und anschließend als benannte Farben in Navigation und Seitenabschnitten verwenden.",
  ...
  sitesThemeAccentColor: (number: number) => `Akzent ${number}`,
