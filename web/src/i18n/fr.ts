...
export const fr: Partial<Catalog> = {
  ...
  moduleBranding: "Identité visuelle",
  ...
  composeEdit: "Modifier le brouillon",
  composeEditTitle: "Modifier le message",
  ...
  crmWorkspaceSubtitle:
    "Faites progresser chaque opportunité du premier échange à la signature.",
  crmFocusEyebrow: "Priorités du jour",
  crmFocusTitle: "État du pipeline",
  crmFocusHint:
    "Commencez par les opportunités qui exigent une décision ou une relance.",
  ...
  crmCreateOpportunity: "Créer une opportunité",
  crmMailOpportunityTitle: "Créer une opportunité depuis l’e-mail",
  crmMailOpportunitySubtitle:
    "Vérifiez les informations commerciales. La conversation complète reste liée à l’opportunité.",
  crmMailOpportunityConfirm: "Créer l’opportunité",
  crmMailOpportunityLoadFailed:
    "Les pipelines commerciaux n’ont pas pu être chargés.",
  crmMailOpportunityCreateFailed: "L’opportunité n’a pas pu être créée.",
  crmMailConversation: "Conversation source",
  crmMailSource: "E-mail",
  crmChoosePipeline: "Choisir un pipeline",
  crmChooseStage: "Choisir une étape",
  crmOpportunityCreated: "Opportunité créée et conversation liée.",
  ...
  crmProjectCreateSummary: (deal: string) =>
    `Création de la réalisation depuis « ${deal} » .`,
  ...
  crmRelatedBillingEmpty:
    "Aucun document de facturation n’a encore été créé depuis cette opportunité.",
  crmRelatedBillingLoadFailed:
    "Les documents de facturation associés n’ont pas pu être chargés.",
  ...
  crmReportCustom: "Période personnalisée",
  crmReportQuickRanges: "Périodes rapides",
  crmReportToday: "Aujourd’hui",
  crmReportYesterday: "Hier",
  crmReportLast7Days: "7 derniers jours",
  crmReportLast28Days: "28 derniers jours",
  crmReportLast30Days: "30 derniers jours",
  crmReportApply: "Appliquer",
  ...
  crmReportWinRateLabel: "Taux de réussite",
  crmReportClosedDeals: "affaires clôturées",
  ...
  projectsSalesOrigin: "Gagné dans Ventes",
  projectsOpenSalesOrigin: "Ouvrir l’opportunité dans Ventes",
  projectsSalesOriginLoadFailed:
    "L’opportunité commerciale d’origine n’a pas pu être chargée.",
  projectsResources: "Espace de travail du projet",
  projectsResourcesSubtitle:
    "Fichiers, conversation, lancement et tâches initiales liés à ce projet.",
  projectsSetupAction: "Configurer l’espace",
  projectsSetupAddAction: "Ajouter des ressources",
  projectsSetupTitle: "Configurer l’espace du projet",
  projectsSetupSubtitle: (project: string) =>
    `Vérifiez ce qu’Alo doit créer pour « ${project} » .`,
  projectsSetupConfirm: "Créer les ressources sélectionnées",
  projectsSetupFiles: "Fichiers de projet partagés",
  projectsSetupFilesDetail:
    "Créer un espace Drive pour les documents et ressources du projet.",
  projectsSetupChat: "Conversation du projet",
  projectsSetupChatDetail:
    "Créer un salon Chat visible par l’organisation pour la coordination.",
  projectsSetupTasks: "Tâches initiales",
  projectsSetupTasksDetail:
    "Ajouter les tâches de cadrage, lancement et planification.",
  projectsSetupKickoff: "Réunion de lancement",
  projectsSetupKickoffDetail:
    "Ajouter un lancement d’une heure à votre agenda avec un rappel.",
  projectsSetupKickoffTime: "Début du lancement",
  projectsSetupReviewNote:
    "Rien n’est créé avant confirmation. Une nouvelle tentative n’ajoute que les ressources manquantes.",
  projectsSetupTaskScope: "Confirmer le périmètre de livraison",
  projectsSetupTaskKickoff: "Préparer le lancement du projet",
  projectsSetupTaskPlan: "Publier le plan de livraison",
  projectsSetupFailed: "Les ressources sélectionnées n’ont pas pu être créées.",
  projectsSetupLoadFailed:
    "Les ressources du projet n’ont pas pu être chargées.",
  projectsFiles: "Fichiers du projet",
  projectsChatRoom: "Chat du projet",
  projectsKickoffMeeting: "Réunion de lancement",
  projectsStarterTasks: (count: number) => `${count} tâches initiales`,
  projectsWorkspaceLoadFailed: "Ce projet n’a pas pu être ouvert.",
  projectsWorkspaceUnavailable: "Projet indisponible",
  projectsRetry: "Réessayer",
  ...
  projectsReportPortfolioTitle: "Rapport du portefeuille",
  projectsReportAllScope: "Tous les projets clients auxquels vous avez accès.",
  ...
  sitesOverview: "Vue generale",
  sitesOverviewHealth: "Etat du site",
  sitesOverviewActions: "Activite recente",
  sitesOverviewReadiness: "Preparation au lancement",
  sitesOverviewReadinessHint:
    "Terminez les elements essentiels avant de partager votre site.",
  sitesOverviewReadyCount: (ready: number, total: number) =>
    `${ready} sur ${total} prets`,
  sitesOverviewDomainStep: "Adresse du site connectee",
  sitesOverviewPagesStep: "Au moins une page creee",
  sitesOverviewLanguagesStep: "Langues activees preparees",
  sitesOverviewPublishStep: "Site publie",
  sitesOverviewContinue: "Continuer la creation",
  sitesOverviewContinueHint: "Accedez directement aux outils les plus utiles.",
  sitesOverviewReadinessScore: "Preparation globale",
  sitesOverviewFoundation: "Fondations",
  sitesOverviewContent: "Contenu des pages",
  sitesOverviewLocalization: "Langues",
  sitesOverviewLaunch: "Publication",
  sitesOverviewElements: "Elements de page",
  sitesOverviewElementsHint:
    "Une bonne page d’accueil combine structure, introduction claire, contenu utile et appel a l’action.",
  sitesOverviewNavigationElements: "Navigation",
  sitesOverviewHeroElements: "Introduction",
  sitesOverviewContentElements: "Contenu",
  sitesOverviewActionElements: "Appel a l’action",
  sitesOverviewSeo: "Configuration de recherche",
  sitesOverviewAccessibility: "Accessibilite",
  sitesOverviewBranding: "Identite de marque",
  sitesOverviewQuality: "Qualite SEO et marque",
  sitesOverviewQualityHint:
    "Ameliorez l’affichage des pages dans les recherches, la comprehension des images et la coherence de votre marque.",
  sitesOverviewSeoTitles: "Titres SEO",
  sitesOverviewMetaDescriptions: "Descriptions meta",
  sitesOverviewImageDescriptions: "Descriptions d’images",
  sitesOverviewLogo: "Logo",
  sitesOverviewFavicon: "Favicon",
  sitesOverviewRecommendedNext: "Prochaine etape recommandee",
  sitesOverviewAddIntroduction: "Ajouter une introduction claire",
  sitesOverviewAddContent: "Ajouter du contenu utile",
  sitesOverviewAddAction: "Ajouter un appel a l’action",
  sitesOverviewEditPage: "Ouvrir l’editeur de page",
  sitesSiteTools: "Parametres du site",
  sitesSiteSettings: "Parametres du site",
  sitesSiteToolsHint: "Domaines, SEO, redirections, statistiques et code",
  sitesSiteSettingsHint:
    "Domaines, historique, statistiques, boutique, formulaires et automatisation.",
  sitesPublishing: "Publication",
  sitesWebsiteNavigation: "Parametres du site",
  ...
  sitesColPage: "Page",
  sitesColPath: "Chemin",
  sitesColSeo: "Recherche",
  sitesColAccess: "AccÃ¨s",
  sitesSearchPages: "Rechercher des pages",
  sitesPageFilter: "Filtre des pages",
  sitesFilterAllPages: "Toutes",
  sitesFilterHomePage: "Page d'accueil",
  sitesFilterProtectedPages: "ProtÃ©gÃ©es",
  sitesSeoReady: "PrÃªte",
  sitesSeoNeedsWork: "Ã€ revoir",
  sitesPublicPage: "Publique",
  sitesNoMatchingPages: "Aucune page ne correspond Ã  cette vue.",
  sitesHomeBadge: "Accueil",
  sitesSortPages: "Trier",
  sitesSortNavigation: "Navigation",
  sitesSortName: "Nom",
  sitesSortPath: "Chemin",
  sitesEditPage: "Modifier",
  sitesPageActions: "Actions de page",
  sitesExpandChildPages: "Développer les pages enfants",
  sitesCollapseChildPages: "Réduire les pages enfants",
  sitesRenamePage: "Renommer",
  sitesRenamePagePrompt:
    "Choisissez le nom de page affiché dans Alo et sur le site web.",
  sitesDuplicatePage: "Dupliquer",
  sitesSetHomepage: "Définir comme page d'accueil",
  sitesSetHomepageConfirm: (page: string) =>
    `Définir ${page} comme page d'accueil ?`,
  sitesDeletePage: "Supprimer",
  sitesDeletePageConfirm: (page: string) =>
    `Supprimer ${page} ? La page brouillon sera retirée de ce site web.`,
  sitesPageActionFailed: "L'action sur la page n'a pas pu être effectuée.",
  sitesLastEdited: (date: string) => `Mis à jour ${date}`,
  sitesStatusPublished: "Publiee",
  sitesViewSite: "Voir le site",
  sitesDomainHealthy: "Domaine pret",
  sitesNotPublishedYet: "Pas encore publie",
  sitesLastPublished: (date: string) => `Derniere publication : ${date}`,
  ...
  sitesLanguagesHint:
    "Choisissez les langues de contenu de ce site. Cela ne change pas la langue alo de chaque editeur.",
  sitesDefaultLanguage: "Langue par défaut",
  sitesAddLanguage: "Ajouter une langue",
  sitesLanguagePlaceholder: "Code de langue, par exemple zh-Hans",
  ...
  sitesSectionTransition: "Transition",
  ...
  sitesTransitionReveal: "Révélation",
  sitesTransitionDirection: "Direction",
  sitesTransitionUp: "Depuis le bas",
  sitesTransitionDown: "Depuis le haut",
  sitesTransitionLeft: "Depuis la droite",
  sitesTransitionRight: "Depuis la gauche",
  sitesTransitionTiming: "Rythme",
  sitesTransitionTrigger: "Commence quand",
  sitesTransitionEarly: "Entre dans la vue",
  ...
  sitesFeaturesLayoutSteps: "Étapes numérotées",
  sitesFeaturesLayoutSpotlight: "Premier en vedette",
  ...
  sitesTextImageLayoutEditorial: "Éditorial",
  sitesTextImageLayoutFullBleed: "Pleine largeur",
  ...
  sitesGalleryLayoutFilmstrip: "Pellicule",
  sitesGalleryLayoutSpotlight: "À la une",
  ...
  sitesTestimonialsLayoutStacked: "Récits empilés",
  ...
  sitesPricingLayoutCompact: "Lignes compactes",
  sitesPricingLayoutEditorial: "Éditorial",
  ...
  sitesTeamLayoutSpotlight: "Responsable à la une",
  sitesTeamLayoutCompact: "Liste compacte",
  sitesSectionFaq: "Questions fréquentes",
  sitesSectionFaqDesc: "Les questions courantes et leurs réponses.",
  sitesFaqLayout: "Disposition de la FAQ",
  sitesFaqLayoutHint: "Choisissez comment les visiteurs parcourent et ouvrent les réponses.",
  sitesFaqLayoutAccordion: "Accordéon",
  sitesFaqLayoutDivided: "Liste séparée",
  sitesFaqLayoutCards: "Cartes de réponses",
  sitesFaqLayoutTwoColumn: "Deux colonnes",
  sitesFaqLayoutEditorial: "Éditorial",
  sitesSectionCta: "Appel à l’action",
  sitesSectionCtaDesc: "Une bannière qui invite à cliquer.",
  sitesCtaLayout: "Disposition de l’appel à l’action",
  sitesCtaLayoutHint: "Choisissez l’accent et le nombre d’actions nécessaires.",
  sitesCtaLayoutCentered: "Centré",
  sitesCtaLayoutSplit: "Séparé",
  sitesCtaLayoutBanner: "Bannière pleine largeur",
  sitesCtaLayoutCard: "Carte flottante",
  ...
  sitesNavSettings: "Paramètres de navigation",
  sitesNavEditorTabs: "Éditeur de navigation",
  sitesNavLinksTab: "Liens",
  ...
  sitesNavDestination: "Page ou section",
  sitesNavPages: "Pages",
  sitesNavSections: "Sections",
  ...
  sitesNavAppearance: "Apparence",
  sitesNavAppearanceShow: "Afficher l’apparence de la navigation",
  sitesNavUsesTheme: "Utilise le thème du site",
  sitesNavUsesBrandRoles: "Utilise les rôles de couleur de la marque",
  sitesNavBrandRoleHint:
    "Choisissez les couleurs du thème du site. Une modification de la palette met à jour toutes les sections liées.",
  sitesNavResetRoles: "Utiliser les valeurs par défaut",
  sitesNavCustomPalette: "Couleurs de navigation personnalisées",
  sitesNavPaletteChoices: "Styles de couleur de navigation",
  sitesNavPaletteTheme: "Thème du site",
  sitesNavPaletteLight: "Clair",
  sitesNavPaletteDark: "Sombre",
  sitesNavPaletteCustom: "Marque personnalisée",
  sitesNavCustomHint:
    "Choisissez une couleur ou saisissez la valeur HEX exacte de votre marque.",
  sitesNavHexValue: (label: string) => `Valeur HEX — ${label}`,
  sitesNavBackground: "Arrière-plan",
  sitesNavText: "Texte",
  sitesNavHover: "Survol",
  sitesNavPreviewBrand: "Votre marque",
  sitesNavPreviewLink: "Lien du menu",
  sitesNavPreviewHover: "État au survol",
  sitesNavContrastPass: "Les couleurs respectent le contraste WCAG AA.",
  sitesNavContrastFail: "Choisissez un contraste d’au moins 4,5:1.",
  ...
  sitesHeroLayout: "Disposition",
  sitesHeroLayoutHint:
    "Choisissez la composition qui met le mieux en valeur votre titre et votre image.",
  sitesHeroLayoutCentered: "Centrée",
  sitesHeroLayoutSplitRight: "Image à droite",
  sitesHeroLayoutSplitLeft: "Image à gauche",
  sitesHeroLayoutBackground: "Image de fond",
  sitesHeroLayoutVideoBackground: "Vidéo de fond",
  sitesHeroLayoutEditorial: "Éditoriale",
  sitesHeroDesign: "Design",
  sitesHeroColors: "Couleurs",
  sitesHeroColorsHint:
    "Choisissez des couleurs réutilisables du thème du site. Le texte des boutons reste lisible automatiquement.",
  sitesHeroBackgroundColor: "Arrière-plan du hero",
  sitesHeroButtonLayout: "Boutons",
  sitesHeroNoButtons: "Aucun bouton",
  sitesHeroOneButton: "Un bouton",
  sitesHeroTwoButtons: "Deux boutons",
  sitesHeroPrimaryButtonColor: "Bouton principal",
  sitesHeroPrimaryButtonText: "Texte du bouton principal",
  sitesHeroPrimaryButtonHover: "Survol du bouton principal",
  sitesHeroPrimaryButtonHoverText: "Texte principal au survol",
  sitesHeroSecondaryButtonColor: "Bouton secondaire",
  sitesHeroSecondaryButtonText: "Texte du bouton secondaire",
  sitesHeroSecondaryButtonHover: "Survol du bouton secondaire",
  sitesHeroSecondaryButtonHoverText: "Texte secondaire au survol",
  sitesHeroHoverBackground: "Arrière-plan au survol",
  sitesHeroHoverText: "Texte au survol",
  sitesHeroAutomaticContrast: "Contraste automatique",
  sitesHeroButtonContrastWarning:
    "Cette combinaison de couleurs est difficile à lire. Choisissez des couleurs plus contrastées.",
  sitesHeroUseThemeColors: "Utiliser les valeurs du thème",
  sitesHeroAnimation: "Animation",
  sitesHeroAnimationHint:
    "Ajoutez une animation d’entrée discrète aux mots et au média. Les visiteurs qui réduisent les animations voient toujours une version fixe.",
  sitesHeroTextAnimation: "Mots",
  sitesHeroMediaAnimation: "Image ou vidéo",
  sitesHeroAnimationNone: "Aucune",
  sitesHeroTextFadeUp: "Fondu ascendant",
  sitesHeroTextWordReveal: "Révélation des mots",
  sitesHeroTextSlideIn: "Glissement",
  sitesHeroMediaFadeIn: "Fondu",
  sitesHeroMediaSlideUp: "Glissement vertical",
  sitesHeroMediaSlowZoom: "Zoom lent",
  sitesHeroAnimationSpeed: "Rythme",
  sitesHeroAnimationQuick: "Rapide",
  ...
  sitesSectionLayoutMinimal: "Minimal",
  ...
  sitesHeroHeightCompact: "Compacte",
  ...
  sitesHeroContentWidth: "Largeur du texte",
  sitesHeroContentWidthNarrow: "Étroite",
  sitesHeroContentWidthBalanced: "Équilibrée",
  sitesHeroContentWidthWide: "Large",
  sitesHeroContent: "Contenu",
  sitesHeroMedia: "Média",
  sitesHeroVideoUrl: "URL de la vidéo",
  sitesHeroVideoUrlHint:
    "Collez un lien HTTPS direct vers une vidéo MP4 ou WebM. Elle est lue en boucle et sans son.",
  sitesHeroVideoFallbackHint:
    "L’image ci-dessous sert d’affiche et remplace la vidéo lorsque les animations sont réduites ou que la vidéo ne charge pas.",
  sitesHeroActions: "Boutons",
  ...
  sitesThemeSubtitle:
    "Ajoutez le logo du site et l’icône du navigateur. Les couleurs viennent d’Identité visuelle.",
  ...
  sitesThemeBrandColors: "Accents de marque",
  sitesThemeBrandColorsHint:
    "Utilisez l’accent principal pour les actions clés et l’accent secondaire pour les éléments de soutien.",
  sitesThemeBrandManaged:
    "Ces couleurs proviennent du kit de marque de votre espace. Modifiez-les une fois dans Identité visuelle et réutilisez-les partout.",
  sitesThemeBaseColors: "Couleurs de base",
  sitesThemeAccentColors: "Couleurs d’accent",
  sitesThemeResetColors: "Utiliser les couleurs du thème",
  sitesThemeBackgroundColor: "Arrière-plan",
  sitesThemeTextColor: "Texte",
  sitesThemeBorderColor: "Bordure",
  sitesThemeAccentColor: (number: number) =>
    number === 1
      ...
      : number === 2
        ? "Accent secondaire"
        : `Accent ${number}`,
  sitesThemeHexValue: (label: string) => `Valeur HEX de ${label}`,
  sitesThemeColorError:
    "Utilisez des couleurs HEX à six chiffres et gardez un contraste texte/arrière-plan d’au moins 4,5:1.",
  sitesThemeLogo: "Logo",
  sitesThemeLogoHint:
  ...
  brandingSubtitle:
    "Créez un kit fiable pour les sites, devis, factures, campagnes, documents et toutes les productions de marque.",
  brandingSave: "Enregistrer le kit",
  brandingSaved: "Kit de marque enregistré",
  brandingUnsaved: "Modifications non enregistrées",
  brandingAccentsTitle: "Accents de marque",
  brandingAccentsHint:
    "Ce sont des rôles partagés dans l’espace, pas les couleurs d’une seule app. Le principal porte les actions clés et la reconnaissance ; le secondaire le soutient.",
  brandingPrimary: "Accent principal",
  brandingPrimaryHint:
    "Utilisez-la pour les actions majeures et les moments de marque : acceptation d’un devis, accents de facture, appels à l’action de campagne et boutons de site.",
  brandingSecondary: "Accent secondaire",
  brandingNeutral: "Espace neutre",
  brandingSecondaryHint:
    "Utilisez cette couleur complémentaire pour les actions secondaires, les accents, les graphiques et le contraste. Elle accompagne l’accent principal sans le concurrencer.",
  brandingAddSecondary: "Ajouter un accent secondaire",
  brandingRemoveSecondary: "Supprimer l’accent secondaire",
  brandingSupportingTitle: "Couleurs de soutien",
  brandingSupportingHint:
    "Ajoutez uniquement des couleurs ayant un usage réutilisable clair : gamme de produits, famille de campagnes, série de graphique ou sous-marque. Donnez-leur un nom parlant.",
  brandingAddSupporting: "Ajouter une couleur de soutien",
  brandingSupportingLimit:
    "Trois couleurs de soutien maximum gardent le système cohérent et simple.",
  brandingColorName: "Nom de la couleur",
  brandingColorHex: "Valeur HEX",
  brandingMoreInfo: (field: string) => `Plus d’informations sur ${field}`,
  brandingSupportingName: (number: number) => `Soutien ${number}`,
  brandingRemoveColor: (name: string) => `Supprimer ${name}`,
  brandingMoveColorUp: (name: string) => `Déplacer ${name} vers le haut`,
  brandingMoveColorDown: (name: string) => `Déplacer ${name} vers le bas`,
  brandingInvalidColor:
    "Donnez à chaque couleur un nom et une valeur HEX à six chiffres.",
  brandingPreviewTitle: "Aperçu en direct",
  brandingPreviewEyebrow: "Marque de l’espace",
  brandingPreviewHeading: "Une identité qui vous ressemble",
  brandingPreviewBody:
    "Vos rôles de marque alimentent les sites, devis en direct, factures, campagnes, documents et tous les emplacements utiles.",
  brandingPreviewPrimary: "Action principale",
  brandingPreviewSecondary: "Action secondaire",
  brandingVisualStudio: "Studio visuel de marque",
  brandingSeeItInUse: "Voyez vos couleurs en situation",
  brandingPreviewContexts: "Contextes d’aperçu de marque",
  brandingPreviewWebsite: "Site web",
  brandingPreviewDocument: "Devis et facture",
  brandingPreviewCampaign: "Campagne",
  brandingToneScale: "Échelle de la couleur principale",
  brandingGenerated: "Dérivée du principal",
  brandingCopyColor: (color: string) => `Copier ${color}`,
  brandingColorCopied: (color: string) => `${color} copié`,
  quoteStudioImportBrandColors: "Importer les couleurs de marque",
  quoteStudioImportBrandTypography: "Importer la typographie de marque",
  brandingToneScaleHint:
    "Utilisez les tons clairs pour les fonds et les tons foncés pour l’accent sans ajouter une nouvelle couleur de marque.",
  brandingContrast: "Texte lisible",
  brandingUseLightText: "Utiliser un texte clair",
  brandingUseDarkText: "Utiliser un texte foncé",
  brandingColorBalance: "Équilibre des couleurs",
  brandingColorBalanceHint:
    "Laissez dominer l’espace neutre, utilisez le Secondaire pour la structure et réservez le Principal aux moments clés.",
  brandingGuidanceTitle: "Palette recommandée",
  brandingGuidancePrimary: "1 principale — obligatoire",
  brandingGuidanceSecondary: "1 secondaire — facultative",
  brandingGuidanceSupporting:
    "0–2 de soutien — courant ; jusqu’à 3 disponibles",
  brandingWcagAa: "WCAG AA",
  brandingBalanceRatio: "70 / 20 / 10",
  brandingNavLabel: "Rubriques de l’identité de marque",
  brandingFoundationNav: "Fondements de marque",
  brandingVisualIdentityNav: "Identité visuelle",
  brandingApplicationsNav: "Applications de marque",
  brandingGuidelinesNav: "Charte",
  brandingSaveFailed:
    "Le kit de marque n’a pas pu être enregistré. Vos modifications sont conservées ; veuillez réessayer.",
  brandingFoundationTitle: "Définissez ce que votre marque représente",
  brandingFoundationSubtitle:
    "Donnez à chaque équipe une base claire et commune pour décider, rédiger et concevoir.",
  brandingBrandName: "Nom de la marque",
  brandingBrandNameHint:
    "Le nom public utilisé sur toutes les productions de marque.",
  brandingBrandNamePlaceholder: "Saisissez le nom de votre marque",
  brandingTagline: "Signature",
  brandingTaglineHint:
    "Une promesse ou une idée courte que le public doit retenir.",
  brandingTaglinePlaceholder: "Rédigez une promesse de marque concise",
  brandingPurpose: "Raison d’être",
  brandingPurposeHint:
    "Expliquez pourquoi la marque existe au-delà de ce qu’elle vend.",
  brandingPurposePlaceholder: "Pourquoi votre marque existe-t-elle ?",
  brandingAudience: "Public",
  brandingAudienceHint:
    "Décrivez précisément les personnes ou organisations que vous servez.",
  brandingAudiencePlaceholder: "À qui cette marque s’adresse-t-elle ?",
  brandingPositioning: "Positionnement",
  brandingPositioningHint:
    "Définissez la place que votre marque veut occuper sur le marché.",
  brandingPositioningPlaceholder:
    "Qu’est-ce qui distingue réellement votre marque ?",
  brandingPersonality: "Personnalité",
  brandingPersonalityHint:
    "Choisissez quelques qualités humaines reconnaissables dans chaque interaction.",
  brandingPersonalityPlaceholder: "Par exemple : claire, chaleureuse, assurée",
  brandingVoice: "Voix et ton",
  brandingVoiceHint:
    "Décrivez la façon dont la marque s’exprime et adapte son ton au contexte.",
  brandingVoicePlaceholder: "Quel ton votre marque doit-elle adopter ?",
  brandingVisualIdentityTitle:
    "Construisez une identité visuelle reconnaissable",
  brandingVisualIdentitySubtitle:
    "Définissez les ressources et rôles réutilisables qu’Alo applique dans votre espace.",
  brandingLogoTitle: "Bibliothèque de logos",
  brandingLogoHint:
    "Regroupez toutes les variantes de logo approuvées et choisissez la version principale utilisée dans Alo.",
  brandingLogoDropTitle: "Déposez des logos ici ou parcourez vos fichiers",
  brandingLogoDropNow: "Déposez pour ajouter ces logos",
  brandingLogoPrimary: "Principal",
  brandingLogoMakePrimary: "Définir comme principal",
  brandingLogoDisplayName: "Nom du logo",
  brandingLogoRemoveTitle: "Supprimer le logo ?",
  brandingLogoRemoveConfirm: (name: string) =>
    `Supprimer ${name} de la bibliothèque de logos ? Cette action est irréversible.`,
  brandingLogoLimit: "Vous pouvez conserver jusqu’à 8 variantes de logo.",
  brandingLogoCount: (count: number, maximum: number) =>
    `${count} sur ${maximum}`,
  brandingLogoReplaceNamed: (name: string) => `Remplacer ${name}`,
  brandingLogoRemoveNamed: (name: string) => `Supprimer ${name}`,
  brandingLogoUpload: "Importer un logo",
  brandingLogoReplace: "Remplacer le logo",
  brandingLogoRemove: "Supprimer le logo",
  brandingLogoRequirements: "SVG, PNG, JPEG ou WebP · 500 Ko maximum",
  brandingLogoTooLarge: "Choisissez un logo de moins de 500 Ko.",
  brandingLogoUnsupported: "Choisissez une image SVG sûre, PNG, JPEG ou WebP.",
  brandingTypographyTitle: "Typographie",
  brandingTypographyHint:
    "Attribuez une police aux titres et une autre aux textes longs et lisibles.",
  brandingHeadingFont: "Police des titres",
  brandingBodyFont: "Police du texte",
  brandingFontInter: "Inter",
  brandingFontArial: "Arial",
  brandingFontGeorgia: "Georgia",
  brandingFontGaramond: "Garamond",
  brandingColorsTitle: "Système de couleurs",
  brandingColorsSubtitle:
    "Définissez une palette courte et accessible par rôle, et non par application.",
  brandingApplicationsTitle: "Voyez la marque en situation réelle",
  brandingApplicationsSubtitle:
    "Vérifiez une identité unique sur les supports réellement utilisés par vos clients et vos équipes.",
  brandingPreviewWorkspaceDocument: "Document",
  brandingGuidelinesTitle: "Votre charte de marque vivante",
  brandingGuidelinesSubtitle:
    "Une référence claire et imprimable, générée depuis le kit utilisé par toutes les apps Alo.",
  brandingPrintGuidelines: "Imprimer la charte",
  brandingGuidelineFoundation: "Fondements",
  brandingGuidelineLogo: "Utilisation du logo",
  brandingGuidelineColors: "Rôles des couleurs",
  brandingGuidelineTypography: "Typographie",
  brandingGuidelineVoice: "Voix et ton",
  brandingGuidelineMissing: "Pas encore défini",
  brandingGuidelineLogoMissing: "Aucun logo principal n’a encore été ajouté.",
  brandingGuidelineLogoRule:
    "Préservez un espace libre autour du logo et ne l’étirez, ne le recolorez ni ne le placez sur un fond qui nuit à sa lisibilité.",
  brandingGuidelineColorRule:
    "Réservez la couleur principale à la reconnaissance et aux actions importantes. Utilisez chaque couleur de soutien uniquement pour son rôle nommé.",
  brandingGuidelineTypographyRule:
    "Utilisez la police de titre pour la hiérarchie et la police de texte pour les contenus longs et lisibles.",
  brandingGuidelineVoiceRule:
    "Conservez la même personnalité tout en adaptant le ton au lecteur et à la situation.",
  brandingSampleName: "Atelier North",
  brandingSampleClient: "Northstar Studio",
  brandingSampleTagline: "La clarté rendue visible",
  brandingPreviewWork: "Projets",
  brandingPreviewAbout: "À propos",
  brandingPreviewStartProject: "Démarrer un projet",
  brandingPreviewWebsiteEyebrow: "Studio de design indépendant",
  brandingPreviewWebsiteHeading:
    "Des idées transformées en marques inoubliables.",
  brandingPreviewWebsiteBody:
    "Une identité claire, des expériences numériques réfléchies et un système que votre équipe utilise avec confiance.",
  brandingPreviewExploreWork: "Voir nos projets",
  brandingPreviewOurApproach: "Notre approche",
  brandingPreviewLaunches: "lancements",
  brandingPreviewCountries: "pays",
  brandingPreviewReferred: "recommandés",
  brandingPreviewQuoteLabel: "DEVIS",
  brandingPreviewPreparedFor: "Préparé pour",
  brandingPreviewQuote: "Devis",
  brandingPreviewBrandStrategy: "Stratégie de marque",
  brandingPreviewVisualIdentity: "Identité visuelle",
  brandingPreviewLaunchToolkit: "Kit de lancement",
  brandingPreviewTotal: "Total",
  brandingPreviewQuoteFooter:
    "Merci de nous donner l’occasion de construire ensemble quelque chose de mémorable.",
  brandingPreviewCampaignBadge: "NOUVELLE COLLECTION",
  brandingPreviewCampaignEyebrow: "Un nouveau chapitre réfléchi",
  brandingPreviewCampaignHeading:
    "Conçue pour votre façon de travailler aujourd’hui.",
  brandingPreviewCampaignBody:
    "Découvrez une collection fondée sur la clarté, le savoir-faire et l’utilité durable.",
  brandingPreviewCampaignAction: "Voir la collection",
  brandingPreviewCampaignLocation: "Bruxelles",
  brandingPreviewDocumentType: "CAHIER DE PROJET",
  brandingPreviewDocumentHeading: "Un chemin plus clair de l’idée au lancement",
  brandingPreviewDocumentBody:
    "Ce document rassemble l’équipe autour d’une raison d’être, d’un public et d’une direction affirmée.",
  brandingPreviewDocumentSection: "L’opportunité",
  brandingPreviewDocumentSectionBody:
    "Transformer un point de vue fort en une expérience cohérente sur chaque point de contact client.",
  ...
  financeWorkspacePurpose:
    "Trésorerie, dépenses et comptes dans un seul espace financier.",
  financeTabOverview: "Vue d’ensemble",
  financeOverviewEyebrow: "Contrôle financier",
  financeOverviewTitle: "Votre espace financier",
  financeOverviewSubtitle:
    "Voyez ce qui exige une action avant que cela ne devienne un problème.",
  financeOverviewLoadFailed:
    "La vue d’ensemble financière n’a pas pu être chargée.",
  financeAttentionCount: (count: number) =>
    `${count} ${count === 1 ? "élément exige" : "éléments exigent"} votre attention`,
  financePendingApprovals: "Approbations en attente",
  financeNeedsDecision: "Notes de frais en attente de décision",
  financeToReimburse: "À rembourser",
  financeReadyToPay: "Notes approuvées à rembourser",
  financeUnreconciled: "Non rapproché",
  financeBankItems: "Transactions bancaires restant à vérifier",
  financeReceivables: "Créances",
  financeOpenDocuments: (count: number) =>
    `${count} ${count === 1 ? "document ouvert" : "documents ouverts"}`,
  financeNeedsAttention: "À traiter",
  financeNeedsAttentionHint:
    "Une seule file pour ce qui peut bloquer une comptabilité propre et une trésorerie saine.",
  financeBanking: "Banque",
  financeLatestStatement: "Dernier relevé",
  financeNoStatements: "Aucun relevé bancaire n’a encore été importé.",
  financeStatementLines: (count: number) =>
    `${count} ${count === 1 ? "transaction" : "transactions"}`,
  financeClosingBalance: "Solde de clôture du relevé",
  financeOpenBanking: "Ouvrir la banque",
  financeTabCashFlow: "Trésorerie",
  financeForecastEyebrow: "Projection",
  financeForecastTitle: "Prévision de trésorerie",
  financeForecastSubtitle:
    "Testez les dates d’encaissement et de décaissement à partir des documents ouverts.",
  financeForecastLoadFailed:
    "La prévision de trésorerie n’a pas pu être chargée.",
  financeForecastExpected: "Prévu",
  financeForecastConservative: "Prudent",
  financeForecastOptimistic: "Optimiste",
  financeForecastHorizon: "Horizon de prévision",
  financeForecast30Days: "30 prochains jours",
  financeForecast60Days: "60 prochains jours",
  financeForecast90Days: "90 prochains jours",
  financeForecastCustomerDelay: "Paiements clients",
  financeForecastSupplierDelay: "Paiements fournisseurs",
  financeForecastDays: (days: number) =>
    days === 0
      ? "À l’échéance"
      : days < 0
        ? `${Math.abs(days)} jours plus tôt`
        : `${days} jours plus tard`,
  financeForecastUnconverted: (count: number) =>
    `${count} ${count === 1 ? "document ouvert est exclu" : "documents ouverts sont exclus"}, faute de valeur en devise comptable.`,
  financeForecastPeriod: "Période prévue",
  financeForecastOpening: "Trésorerie initiale",
  financeForecastProjected: "Trésorerie projetée",
  financeForecastUnavailable: "Importer un solde bancaire",
  financeForecastWeekly: "Mouvements hebdomadaires",
  financeForecastWeeklyHint:
    "Mouvements attendus et solde courant calculé par le serveur.",
  financeForecastWeek: "Semaine",
  financeForecastIncoming: "Entrées",
  financeForecastOutgoing: "Sorties",
  financeForecastNet: "Mouvement net",
  financeForecastBalance: "Solde projeté",
  financeTabProfitability: "Rentabilité",
  financeProfitabilityEyebrow: "Projets et finance",
  financeProfitabilityTitle: "Rentabilité des projets",
  financeProfitabilitySubtitle:
    "Suivez la valeur acquise, non facturée et les risques budgétaires depuis Finance.",
  financeProfitabilityLoadFailed:
    "La rentabilité des projets n’a pas pu être chargée.",
  financeOpenProjects: "Ouvrir le rapport Projets",
  financeThisQuarter: "Ce trimestre",
  financeLastQuarter: "Trimestre précédent",
  financeActiveEngagements: "Missions actives",
  financeProfitabilityExceptions: "À traiter",
  financeUnbilledValue: "Valeur non facturée",
  financeProfitabilityEmpty: "Aucune valeur de projet sur cette période",
  financeProfitabilityEmptyHint:
    "Le temps approuvé apparaîtra ici lorsqu’il se trouvera dans cette période.",
  financeProfitabilityBasis: (from: string, to: string) =>
    `Temps approuvé du ${from} au ${to} ; la consommation budgétaire est mesurée jusqu’à la date de fin.`,
  financeProjectPeriodValue: "Travail approuvé sur la période",
  financeOverBudget: "Budget dépassé",
  financeEarnedValue: "Valeur acquise",
  financeBudgetUsed: "Budget financier utilisé",
  financeBudgetRemaining: (amount: string) => `${amount} restant`,
  financeUnratedMinutes: (minutes: number) =>
    `${minutes} minutes facturables sans tarif`,
  financeNoMoneyBudget: "Aucun budget financier",
  financeTabControls: "Contrôles",
  financePolicyEyebrow: "Gouvernance des dépenses",
  financePolicyTitle: "Contrôles des dépenses",
  financePolicySubtitle:
    "Définissez les justificatifs et validations que le serveur impose avant toute comptabilisation.",
  financePolicyLoadFailed:
    "Les contrôles des dépenses n’ont pas pu être chargés.",
  financePolicySaveFailed:
    "Les contrôles des dépenses n’ont pas pu être enregistrés.",
  financePolicyRules: "Politique de dépenses",
  financePolicyRulesHint: (currency: string) =>
    `Les seuils sont exprimés dans la devise comptable, ${currency}.`,
  financeReceiptRule: "Exiger un justificatif",
  financeReceiptRuleHint:
    "À partir de ce montant, une note ne peut être approuvée sans justificatif joint.",
  financeProjectRule: "Exiger un projet",
  financeProjectRuleHint:
    "À partir de ce montant, une note doit être affectée à une mission avant approbation.",
  financeSecondApprovalRule: "Exiger deux approbateurs",
  financeSecondApprovalRuleHint:
    "Les montants élevés restent soumis jusqu’à l’accord de deux approbateurs différents.",
  financePolicyEnabled: "Activé",
  financePolicyDisabled: "Désactivé",
  financePolicySaved: "Contrôles enregistrés",
  financeSaving: "Enregistrement…",
  financeSavePolicy: "Enregistrer les contrôles",
  financeApprovalRecorded: (count: number, required: number) =>
    `Approbation ${count} sur ${required} enregistrée. Une autre personne doit terminer.`,
  financeApprovalProgress: (count: number, required: number) =>
    `${count} approbations sur ${required}`,
  ...
  financeBankSearchPlaceholder:
    "Rechercher un payeur, un IBAN ou une référence…",
  ...
  financeBankSelectLine: (name: string) =>
    `Sélectionner la transaction de ${name}`,
  financeBankConfirmSelected: (count: number) =>
    `Confirmer ${count} sélectionnés`,
  ...
  chatSourceOne: "Réponse fondée sur 1 source",
  chatSourceCount: "Réponse fondée sur {count} sources",
  chatSourceEmail: "e-mail",
  chatSourceChat: "message de discussion",
  chatSourceEvent: "événement d'agenda",
  chatSourceRemembered: "mémorisé ici",
  ...
  taskSummaryTotal: (count: number) => `${count} au total`,
  taskSummaryActive: (count: number) => `${count} en cours`,
  taskSummaryOverdue: (count: number) => `${count} en retard`,
  taskSummaryCompleted: (count: number) => `${count} terminées`,
  ...
  billingImportPrices: "Importer des prix",
  billingPriceList: "liste de prix",
  billingColVat: "TVA",
  billingImportImageUnreadable: "Impossible de lire l’image.",
  ...
  billingImportColumnLabel: (field: string) => `Colonne ${field}`,
  billingImportChooseColumn: "Choisir une colonne",
  billingImportColumn: "Importer",
  billingImportIncludeRow: (name: string) => `Importer ${name}`,
  ...
  colorPickerHex: "HEX",
  colorPickerHexColour: "Couleur hexadécimale",
  colorPickerCopyHex: "Copier la couleur hexadécimale",
  colorPickerUseColour: (colour: string) => `Utiliser ${colour}`,
  colorPickerSaveColour: "Enregistrer la couleur actuelle",
  colorPickerUseDefault: "Utiliser la couleur par défaut",
  billingEditProductImage: "Modifier l’image du produit",
  billingCloseImageEditor: "Fermer l’éditeur d’image",
  ...
  billingFillFrame: "Remplir le cadre",
  ...
  billingConnectionsCurrencyField: "Champ de la devise",
  billingConnectionsCustomHeader: "En-tête d’authentification personnalisé",
  billingConnectionsHeaderName: "Nom de l’en-tête",
  billingConnectionsHeaderValue: "Valeur de l’en-tête",
  ...
  billingConnectionsChooseDelivery: "Choisissez un mode de transmission",
  billingConnectionsPricesToShare: "Prix à partager",
  ...
  quoteStudioVatId: "N° de TVA",
  quoteStudioCompanyNumber: "N° d’entreprise",
  quoteStudioQuotation: "Devis",
  quoteStudioPreparedFor: "Préparé pour",
  quoteStudioIssued: "Émis le",
  quoteStudioValidUntil: "Valable jusqu’au",
  quoteStudioEditHeader: "Modifier l’en-tête",
  quoteStudioTableName: "Nom du tableau",
  quoteStudioPricingTable: "Tableau de prix",
  quoteStudioTableSettings: "Paramètres du tableau",
  quoteStudioEditBlock: "Modifier le bloc",
  quoteStudioMoveUp: "Déplacer vers le haut",
  quoteStudioMoveDown: "Déplacer vers le bas",
  quoteStudioDuplicate: "Dupliquer",
  quoteStudioDelete: "Supprimer",
  quoteStudioHeadingLevel: "Niveau de titre",
  quoteStudioHeading1: "Titre 1",
  quoteStudioHeading2: "Titre 2",
  quoteStudioHeading3: "Titre 3",
  ...
  quoteStudioMoveItemUp: "Déplacer l’élément vers le haut",
  quoteStudioMoveItemDown: "Déplacer l’élément vers le bas",
  quoteStudioRemoveItem: "Supprimer l’élément",
  quoteStudioAddItemBelow: "Ajouter un élément dessous",
  quoteStudioListFormatting: "Mise en forme de l’élément",
  ...
  quoteStudioTextFormatting: "Mise en forme du texte",
  quoteStudioBulletList: "Liste à puces",
  quoteStudioNumberedList: "Liste numérotée",
  quoteStudioColumnWidth: "Largeur des colonnes",
  quoteStudioSideBySideOnly: "Uniquement côte à côte",
  quoteStudioZoom: "Zoom",
  quoteStudioReset: "Réinitialiser",
  ...
  quoteStudioAddContent: "Ajouter du contenu",
  quoteStudioAddToQuotation: "Ajouter au devis",
  quoteStudioAddToQuotationHelp: "Choisissez le prochain élément du document.",
  quoteStudioCloseBlockPicker: "Fermer le sélecteur de blocs",
  quoteStudioSearchBlocks: "Rechercher des blocs…",
  ...
  quoteStudioQuoteLogo: "Logo du devis",
  ...
  quoteStudioCompanyNamePlaceholder: "Nom de votre entreprise",
  quoteStudioWebsite: "Site web",
  quoteStudioWebsitePlaceholder: "www.entreprise.com",
  ...
  quoteStudioContactPerson: "Personne de contact",
  quoteStudioContactNamePlaceholder: "Nom du contact",
  ...
  quoteStudioQuote: "Citation",
  quoteStudioParagraphHelp: "Ajoutez un texte explicatif",
  quoteStudioQuoteHelp: "Mettez une déclaration en valeur",
  quoteStudioBulletListHelp: "Énumérez les points clés",
  quoteStudioNumberedListHelp: "Présentez des étapes ordonnées",
  quoteStudioImageHelp: "Importez et disposez un visuel",
  quoteStudioPricingTableHelp: "Regroupez les produits et services",
  quoteStudioTable: "Tableau",
  ...
  quoteStudioDividerThicknessHelp: "Sélectionnez l’épaisseur du trait.",
  ...
  quoteStudioAccentHelp: "Actions et éléments de marque",
  quoteStudioContactIcons: "Icônes de contact",
  quoteStudioContactIconsHelp: "Icônes d’e-mail, de téléphone et de site web",
  quoteStudioPage: "Page",
  quoteStudioPageHelp: "Arrière-plan visible par le client",
  quoteStudioHeader: "En-tête",
  quoteStudioHeaderHelp: "Arrière-plan de l’en-tête",
  quoteStudioText: "Texte",
  quoteStudioTextHelp: "Texte principal",
  quoteStudioBulletDots: "Puces",
  quoteStudioListMarkers: "Repères de liste",
  ...
  quoteStudioDetailedHelp: "Descriptions avec images facultatives",
  ...
  quoteStudioNetVatTotal: "HT, TVA et total",
  quoteStudioNetVatTotalHelp: "Recommandé pour la plupart des devis",
  quoteStudioVatBreakdown: "Détail de la TVA",
  quoteStudioVatBreakdownHelp: "Afficher chaque taux de TVA",
  quoteStudioCurrencyCode: "Code devise",
  quoteStudioCurrencyCodeHelp: "Afficher EUR, USD ou la devise du devis",
  quoteStudioEmphasizeTotal: "Mettre le total en valeur",
  quoteStudioEmphasizeTotalHelp: "Renforcer la hiérarchie du montant final",
  quoteStudioVatNote: "Note sur la TVA",
  ...
  billingCustomizeInvoice: "Personnaliser la facture",
  billingInvoiceLabel: "Facture",
  billingInvoiceEdit: "Modifier la facture",
  billingInvoicePreview: "Aperçu de la facture",
  billingQuoteQrLabel: "Scanner pour accepter ce devis",
  billingQuoteQrSubject: (number: string) => `Acceptation du devis ${number}`,
  billingQuoteQrBody: (number: string) =>
    `Je confirme que j’accepte le devis ${number}. Merci de me contacter si vous avez besoin d’informations complémentaires.`,
  billingInvoiceQrLabel: "Scanner avec votre application bancaire pour payer",
  ...
  quoteStudioChooseListStyle: "Choisissez un style de liste",
  quoteStudioIndentItem: "Augmenter le retrait",
  quoteStudioOutdentItem: "Réduire le retrait",
  quoteStudioListStyleName: (style: string) =>
    ({
      decimal: "Chiffres, lettres, romains",
      parenthesis: "Chiffres avec parenthèses",
      outline: "Plan (1.1, 1.2.1)",
      "upper-alpha": "Lettres majuscules",
      roman: "Chiffres romains",
      "leading-zero": "Zéros initiaux (01, 02)",
      disc: "Puces rondes",
      diamond: "Losanges et flèches",
      square: "Carrés",
      arrow: "Flèches",
      star: "Étoiles",
      chevron: "Chevrons",
  ...
  quoteStudioImageLeft: "Image à gauche",
  quoteStudioImageRight: "Image à droite",
  quoteStudioNatural: "Naturel",
  quoteStudioWide: "Large",
  quoteStudioSquare: "Carré",
  quoteStudioFillFrame: "Remplir le cadre",
  ...
  quoteStudioNoProposalContent: "Aucun contenu de proposition",
  quoteStudioStartQuotationBelow: "Commencez votre devis ci-dessous",
  billingExitPreview: "Quitter l’aperçu",
  quoteStudioModern: "Moderne",
  quoteStudioModernHelp: "Clair et assuré",
  quoteStudioEditorial: "Éditorial",
  quoteStudioEditorialHelp: "Des titres qui portent le récit",
  quoteStudioMinimal: "Minimal",
  quoteStudioMinimalHelp: "Sobre et précis",
  quoteStudioSignature: "Signature",
  quoteStudioSignatureHelp: "Identité et détails du devis équilibrés",
  quoteStudioHeaderEditorialHelp: "Une ouverture affirmée, guidée par le titre",
  quoteStudioBrandBand: "Bande de marque",
  quoteStudioBrandBandHelp: "Une introduction qui affirme davantage la marque",
  quoteStudioHeaderMinimalHelp: "Sobre, compact et précis",
  ...
  billingConnectionsOnceDay: "Une fois par jour",
