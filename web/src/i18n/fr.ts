...
export const fr: Partial<Catalog> = {
  ...
  sitesSiteSettingsHint: "Domaines, historique, statistiques, boutique, formulaires et automatisation.",
  ...
  sitesNavBrandRoleHint: "Choisissez les couleurs du thème du site. Une modification de la palette met à jour toutes les sections liées.",
  ...
  sitesNavCustomHint: "Choisissez une couleur ou saisissez la valeur HEX exacte de votre marque.",
  ...
  sitesThemeBrandColorsHint: "Utilisez l’accent principal pour les actions clés et l’accent secondaire pour les éléments de soutien.",
  sitesThemeBrandManaged: "Ces couleurs proviennent du kit de marque de votre espace. Modifiez-les une fois dans Identité visuelle et réutilisez-les partout.",
  ...
  sitesThemeAccentColor: (number: number) =>
    number === 1 ? "Accent principal" : number === 2 ? "Accent secondaire" : `Accent ${number}`,
  sitesThemeHexValue: (label: string) => `Valeur HEX de ${label}`,
  sitesThemeColorError: "Utilisez des couleurs HEX à six chiffres et gardez un contraste texte/arrière-plan d’au moins 4,5:1.",
  sitesThemeLogo: "Logo",
  sitesThemeLogoHint:
  ...
  brandingSubtitle: "Créez un kit fiable pour les sites, devis, factures, campagnes, documents et toutes les productions de marque.",
  ...
  brandingAccentsHint: "Ce sont des rôles partagés dans l’espace, pas les couleurs d’une seule app. Le principal porte les actions clés et la reconnaissance ; le secondaire le soutient.",
  brandingPrimary: "Accent principal",
  brandingPrimaryHint: "Utilisez-la pour les actions majeures et les moments de marque : acceptation d’un devis, accents de facture, appels à l’action de campagne et boutons de site.",
  brandingSecondary: "Accent secondaire",
  brandingNeutral: "Espace neutre",
  brandingSecondaryHint: "Utilisez cette couleur complémentaire pour les actions secondaires, les accents, les graphiques et le contraste. Elle accompagne l’accent principal sans le concurrencer.",
  ...
  brandingSupportingHint: "Ajoutez uniquement des couleurs ayant un usage réutilisable clair : gamme de produits, famille de campagnes, série de graphique ou sous-marque. Donnez-leur un nom parlant.",
  brandingAddSupporting: "Ajouter une couleur de soutien",
  brandingSupportingLimit: "Trois couleurs de soutien maximum gardent le système cohérent et simple.",
  ...
  brandingInvalidColor: "Donnez à chaque couleur un nom et une valeur HEX à six chiffres.",
  ...
  brandingPreviewBody: "Vos rôles de marque alimentent les sites, devis en direct, factures, campagnes, documents et tous les emplacements utiles.",
  ...
  brandingToneScaleHint: "Utilisez les tons clairs pour les fonds et les tons foncés pour l’accent sans ajouter une nouvelle couleur de marque.",
  ...
  brandingColorBalanceHint: "Laissez dominer l’espace neutre, utilisez le Secondaire pour la structure et réservez le Principal aux moments clés.",
  ...
  brandingGuidanceSupporting: "0–2 de soutien — courant ; jusqu’à 3 disponibles",
  ...
  brandingSaveFailed: "Le kit de marque n’a pas pu être enregistré. Vos modifications sont conservées ; veuillez réessayer.",
  brandingFoundationTitle: "Définissez ce que votre marque représente",
  brandingFoundationSubtitle: "Donnez à chaque équipe une base claire et commune pour décider, rédiger et concevoir.",
  brandingBrandName: "Nom de la marque",
  brandingBrandNameHint: "Le nom public utilisé sur toutes les productions de marque.",
  brandingBrandNamePlaceholder: "Saisissez le nom de votre marque",
  brandingTagline: "Signature",
  brandingTaglineHint: "Une promesse ou une idée courte que le public doit retenir.",
  brandingTaglinePlaceholder: "Rédigez une promesse de marque concise",
  brandingPurpose: "Raison d’être",
  brandingPurposeHint: "Expliquez pourquoi la marque existe au-delà de ce qu’elle vend.",
  brandingPurposePlaceholder: "Pourquoi votre marque existe-t-elle ?",
  brandingAudience: "Public",
  brandingAudienceHint: "Décrivez précisément les personnes ou organisations que vous servez.",
  brandingAudiencePlaceholder: "À qui cette marque s’adresse-t-elle ?",
  brandingPositioning: "Positionnement",
  brandingPositioningHint: "Définissez la place que votre marque veut occuper sur le marché.",
  brandingPositioningPlaceholder: "Qu’est-ce qui distingue réellement votre marque ?",
  brandingPersonality: "Personnalité",
  brandingPersonalityHint: "Choisissez quelques qualités humaines reconnaissables dans chaque interaction.",
  brandingPersonalityPlaceholder: "Par exemple : claire, chaleureuse, assurée",
  brandingVoice: "Voix et ton",
  brandingVoiceHint: "Décrivez la façon dont la marque s’exprime et adapte son ton au contexte.",
  brandingVoicePlaceholder: "Quel ton votre marque doit-elle adopter ?",
  brandingVisualIdentityTitle: "Construisez une identité visuelle reconnaissable",
  brandingVisualIdentitySubtitle: "Définissez les ressources et rôles réutilisables qu’Alo applique dans votre espace.",
  brandingLogoTitle: "Bibliothèque de logos",
  brandingLogoHint: "Regroupez toutes les variantes de logo approuvées et choisissez la version principale utilisée dans Alo.",
  ...
  brandingLogoRemoveConfirm: (name: string) => `Supprimer ${name} de la bibliothèque de logos ? Cette action est irréversible.`,
  brandingLogoLimit: "Vous pouvez conserver jusqu’à 8 variantes de logo.",
  brandingLogoCount: (count: number, maximum: number) => `${count} sur ${maximum}`,
  ...
  brandingTypographyHint: "Attribuez une police aux titres et une autre aux textes longs et lisibles.",
  ...
  brandingColorsSubtitle: "Définissez une palette courte et accessible par rôle, et non par application.",
  brandingApplicationsTitle: "Voyez la marque en situation réelle",
  brandingApplicationsSubtitle: "Vérifiez une identité unique sur les supports réellement utilisés par vos clients et vos équipes.",
  brandingPreviewWorkspaceDocument: "Document",
  brandingGuidelinesTitle: "Votre charte de marque vivante",
  brandingGuidelinesSubtitle: "Une référence claire et imprimable, générée depuis le kit utilisé par toutes les apps Alo.",
  ...
  brandingGuidelineLogoRule: "Préservez un espace libre autour du logo et ne l’étirez, ne le recolorez ni ne le placez sur un fond qui nuit à sa lisibilité.",
  brandingGuidelineColorRule: "Réservez la couleur principale à la reconnaissance et aux actions importantes. Utilisez chaque couleur de soutien uniquement pour son rôle nommé.",
  brandingGuidelineTypographyRule: "Utilisez la police de titre pour la hiérarchie et la police de texte pour les contenus longs et lisibles.",
  brandingGuidelineVoiceRule: "Conservez la même personnalité tout en adaptant le ton au lecteur et à la situation.",
  ...
  brandingPreviewWebsiteHeading: "Des idées transformées en marques inoubliables.",
  brandingPreviewWebsiteBody: "Une identité claire, des expériences numériques réfléchies et un système que votre équipe utilise avec confiance.",
  ...
  brandingPreviewQuoteFooter: "Merci de nous donner l’occasion de construire ensemble quelque chose de mémorable.",
  brandingPreviewCampaignBadge: "NOUVELLE COLLECTION",
  brandingPreviewCampaignEyebrow: "Un nouveau chapitre réfléchi",
  brandingPreviewCampaignHeading: "Conçue pour votre façon de travailler aujourd’hui.",
  brandingPreviewCampaignBody: "Découvrez une collection fondée sur la clarté, le savoir-faire et l’utilité durable.",
  ...
  brandingPreviewDocumentBody: "Ce document rassemble l’équipe autour d’une raison d’être, d’un public et d’une direction affirmée.",
  brandingPreviewDocumentSection: "L’opportunité",
  brandingPreviewDocumentSectionBody: "Transformer un point de vue fort en une expérience cohérente sur chaque point de contact client.",
