...
export const fr: Partial<Catalog> = {
  ...
  sitesThemeSubtitle:
    "Choisissez un style de départ, définissez vos couleurs de marque et ajoutez votre logo.",
  ...
  sitesThemeBrandColors: "Couleurs de marque",
  sitesThemeBrandColorsHint: "Définissez-les une fois, puis réutilisez ces couleurs nommées dans la navigation et les sections.",
  ...
  sitesThemeAccentColor: (number: number) => `Accent ${number}`,
