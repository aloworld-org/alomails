...
export const fr: Partial<Catalog> = {
  ...
  financePolicySubtitle: "Définissez les justificatifs et validations que le serveur impose avant toute comptabilisation.",
  financePolicyLoadFailed: "Les contrôles des dépenses n’ont pas pu être chargés.",
  financePolicySaveFailed: "Les contrôles des dépenses n’ont pas pu être enregistrés.",
  financePolicyRules: "Politique de dépenses",
  financePolicyRulesHint: (currency: string) => `Les seuils sont exprimés dans la devise comptable, ${currency}.`,
  financeReceiptRule: "Exiger un justificatif",
  financeReceiptRuleHint: "À partir de ce montant, une note ne peut être approuvée sans justificatif joint.",
  financeProjectRule: "Exiger un projet",
  financeProjectRuleHint: "À partir de ce montant, une note doit être affectée à une mission avant approbation.",
  financeSecondApprovalRule: "Exiger deux approbateurs",
  financeSecondApprovalRuleHint: "Les montants élevés restent soumis jusqu’à l’accord de deux approbateurs différents.",
  ...
  financeApprovalRecorded: (count: number, required: number) => `Approbation ${count} sur ${required} enregistrée. Une autre personne doit terminer.`,
  financeApprovalProgress: (count: number, required: number) => `${count} approbations sur ${required}`,
