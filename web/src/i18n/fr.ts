...
export const fr: Partial<Catalog> = {
  ...
  sitesMoveUp: "Monter",
  sitesMoveDown: "Descendre",
  sitesEditSection: "Modifier la section",
  sitesDeleteSection: "Supprimer la section",
  ...
  meetReadyTitle: "Vous êtes prêt à rejoindre la réunion",
  ...
  chatReplyInThread: "Répondre dans le fil",
