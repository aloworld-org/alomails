...
export const nl: Partial<Catalog> = {
  ...
  sitesThemeSubtitle: "Kies een basisstijl, stel uw merkkleuren in en voeg uw logo toe.",
  ...
  sitesThemeBrandColors: "Merkkleuren",
  sitesThemeBrandColorsHint: "Stel ze één keer in en hergebruik de benoemde kleuren in navigatie en paginasecties.",
