...
export const nl: Partial<Catalog> = {
  ...
  sitesMoveUp: "Omhoog",
  sitesMoveDown: "Omlaag",
  sitesEditSection: "Sectie bewerken",
  sitesDeleteSection: "Sectie verwijderen",
  ...
  chatReplyInThread: "In thread beantwoorden",
  ...
  hrDirectoryEmptyTitle: "Er staat nog niemand in de directory",
  hrDirectorySearch: "Mensen zoeken",
  hrDirectoryViews: "Hoe u de directory leest",
