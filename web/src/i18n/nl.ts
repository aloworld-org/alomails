...
export const nl: Partial<Catalog> = {
  ...
  sitesSiteToolsHint: "Domeinen, SEO-standaarden, redirects, statistieken en code",
  sitesSiteSettingsHint: "Domeinen, publicatiegeschiedenis, statistieken, winkel, formulieren en automatisering.",
  ...
  sitesNavBrandRoleHint: "Kies kleuren uit het sitethema. Wijzig het merkpalet één keer en alle gekoppelde secties volgen.",
  ...
  sitesNavCustomHint: "Kies elke kleur of voer de exacte HEX-waarde van je merk in.",
  ...
  sitesThemeSubtitle: "Voeg uw sitelogo en browserpictogram toe. Merkkleuren komen uit Huisstijl.",
  ...
  sitesThemeBrandColorsHint: "Gebruik het primaire accent voor belangrijke acties en het secundaire accent voor ondersteunende nadruk.",
  sitesThemeBrandManaged: "Deze kleuren komen uit uw merkset. Wijzig ze eenmaal in Huisstijl en hergebruik ze overal.",
  ...
  sitesThemeAccentColor: (number: number) =>
    number === 1 ? "Primair accent" : number === 2 ? "Secundair accent" : `Accent ${number}`,
  sitesThemeHexValue: (label: string) => `HEX-waarde voor ${label}`,
  sitesThemeColorError: "Gebruik HEX-kleuren van zes tekens en houd tekst leesbaar op de achtergrond (minstens 4,5:1).",
  sitesThemeLogo: "Logo",
  sitesThemeLogoHint:
  ...
  brandingSubtitle: "Maak één betrouwbare merkset voor websites, offertes, facturen, campagnes, documenten en alle merkuitingen.",
  ...
  brandingAccentsHint: "Dit zijn gedeelde werkruimterollen, niet kleuren voor één app. Primair stuurt belangrijke acties en herkenning; Secundair ondersteunt zonder te concurreren.",
  brandingPrimary: "Primair accent",
  brandingPrimaryHint: "Gebruik dit voor de belangrijkste acties en herkenbare merkmomenten, zoals offerteacceptatie, factuuraccenten, campagneknoppen en websiteacties.",
  brandingSecondary: "Secundair accent",
  brandingNeutral: "Neutrale ruimte",
  brandingSecondaryHint: "Gebruik deze aanvullende kleur voor secundaire acties, ondersteunende accenten, grafieken en contrast. Ze moet samenwerken met Primair, niet ermee concurreren.",
  ...
  brandingSupportingHint: "Voeg alleen kleuren toe met een duidelijk herbruikbaar doel, zoals een productlijn, campagnefamilie, grafiekreeks of submerk. Geef elke kleur een betekenisvolle naam.",
  brandingAddSupporting: "Ondersteunende kleur toevoegen",
  brandingSupportingLimit: "Maximaal drie ondersteunende kleuren houdt het palet consistent en eenvoudig.",
  ...
  brandingInvalidColor: "Geef elke kleur een naam en een HEX-waarde van zes tekens.",
  brandingPreviewTitle: "Live voorbeeld",
  brandingPreviewEyebrow: "Werkruimtemerk",
  brandingPreviewHeading: "Onmiskenbaar van u",
  brandingPreviewBody: "Uw merkrollen worden hergebruikt in websites, live offertes, facturen, campagnes, documenten en overal waar ze nodig zijn.",
  ...
  brandingToneScaleHint: "Gebruik lichtere tinten voor achtergronden en donkere tinten voor nadruk zonder een nieuwe merkkleur toe te voegen.",
  ...
  brandingColorBalanceHint: "Laat neutrale ruimte leiden, gebruik Secundair voor structuur en bewaar Primair voor belangrijke momenten.",
  ...
  brandingGuidanceSupporting: "0–2 ondersteunend — gebruikelijk; maximaal 3 beschikbaar",
  ...
  brandingSaveFailed: "De merkset kon niet worden opgeslagen. Uw wijzigingen zijn behouden; probeer het opnieuw.",
  brandingFoundationTitle: "Leg vast waar uw merk voor staat",
  brandingFoundationSubtitle: "Geef elk team dezelfde heldere basis voor beslissingen, teksten en ontwerp.",
  brandingBrandName: "Merknaam",
  brandingBrandNameHint: "De openbare naam die in alle merkuitingen wordt gebruikt.",
  brandingBrandNamePlaceholder: "Voer uw merknaam in",
  brandingTagline: "Slogan",
  brandingTaglineHint: "Een korte belofte of gedachte die mensen moeten onthouden.",
  brandingTaglinePlaceholder: "Schrijf een beknopte merkbelofte",
  brandingPurpose: "Doel",
  brandingPurposeHint: "Leg uit waarom het merk bestaat, naast wat het verkoopt.",
  brandingPurposePlaceholder: "Waarom bestaat uw merk?",
  brandingAudience: "Doelgroep",
  brandingAudienceHint: "Beschrijf duidelijk welke mensen of organisaties u bedient.",
  brandingAudiencePlaceholder: "Voor wie is dit merk bedoeld?",
  brandingPositioning: "Positionering",
  brandingPositioningHint: "Bepaal welke plaats uw merk in de markt wil innemen.",
  brandingPositioningPlaceholder: "Wat maakt uw merk werkelijk anders?",
  brandingPersonality: "Persoonlijkheid",
  brandingPersonalityHint: "Kies enkele menselijke eigenschappen die in elke interactie herkenbaar moeten zijn.",
  brandingPersonalityPlaceholder: "Bijvoorbeeld: helder, warm, zelfverzekerd",
  brandingVoice: "Stem en toon",
  brandingVoiceHint: "Beschrijf hoe het merk spreekt en de toon aan de context aanpast.",
  brandingVoicePlaceholder: "Hoe moet het merk klinken?",
  brandingVisualIdentityTitle: "Bouw een herkenbare visuele identiteit",
  brandingVisualIdentitySubtitle: "Stel de herbruikbare middelen en rollen in die Alo in uw werkruimte toepast.",
  brandingLogoTitle: "Logobibliotheek",
  brandingLogoHint: "Bewaar alle goedgekeurde logovarianten bij elkaar en kies de primaire versie voor gebruik in Alo.",
  ...
  brandingLogoRemoveConfirm: (name: string) => `${name} uit de logobibliotheek verwijderen? Dit kan niet ongedaan worden gemaakt.`,
  brandingLogoLimit: "Je kunt maximaal 8 logovarianten bewaren.",
  brandingLogoCount: (count: number, maximum: number) => `${count} van ${maximum}`,
  ...
  brandingLogoUnsupported: "Kies een veilige SVG-, PNG-, JPEG- of WebP-afbeelding.",
  brandingTypographyTitle: "Typografie",
  brandingTypographyHint: "Wijs één lettertype toe aan koppen en één aan goed leesbare lopende tekst.",
  ...
  brandingColorsSubtitle: "Definieer een klein, toegankelijk palet per rol in plaats van per app.",
  brandingApplicationsTitle: "Bekijk het merk in echt werk",
  brandingApplicationsSubtitle: "Beoordeel één identiteit in de uitingen die klanten en teams werkelijk gebruiken.",
  brandingPreviewWorkspaceDocument: "Document",
  brandingGuidelinesTitle: "Uw levende merkrichtlijnen",
  brandingGuidelinesSubtitle: "Een heldere, afdrukbare referentie uit dezelfde merkset die elke Alo-app gebruikt.",
  ...
  brandingGuidelineLogoRule: "Houd vrije ruimte rond het logo en rek het nooit uit, verander de kleur niet en plaats het niet op een achtergrond die de leesbaarheid vermindert.",
  brandingGuidelineColorRule: "Bewaar de primaire kleur voor herkenning en belangrijke acties. Gebruik ondersteunende kleuren alleen voor hun benoemde rol.",
  brandingGuidelineTypographyRule: "Gebruik het koplettertype voor hiërarchie en het tekstlettertype voor langere, leesbare inhoud.",
  brandingGuidelineVoiceRule: "Behoud dezelfde persoonlijkheid en pas de toon aan de lezer en situatie aan.",
  ...
  brandingPreviewWebsiteHeading: "Ideeën gevormd tot merken die mensen onthouden.",
  brandingPreviewWebsiteBody: "Een heldere identiteit, doordachte digitale ervaringen en een systeem dat uw team met vertrouwen gebruikt.",
  ...
  brandingPreviewQuoteFooter: "Dank u voor de kans om samen iets gedenkwaardigs te bouwen.",
  ...
  brandingPreviewCampaignBody: "Ontdek een collectie gebouwd rond helderheid, vakmanschap en blijvende bruikbaarheid.",
  ...
  brandingPreviewDocumentBody: "Dit document brengt het team samen rond één doel, één doelgroep en één zelfverzekerde richting.",
  brandingPreviewDocumentSection: "De kans",
  brandingPreviewDocumentSectionBody: "Maak van een sterk standpunt een consistente ervaring op elk klantcontactpunt.",
