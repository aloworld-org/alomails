...
export const nl: Partial<Catalog> = {
  ...
  financePolicySubtitle: "Stel bewijs- en goedkeuringsregels in die de server afdwingt voordat een declaratie wordt geboekt.",
  financePolicyLoadFailed: "De uitgavencontroles konden niet worden geladen.",
  financePolicySaveFailed: "De uitgavencontroles konden niet worden opgeslagen.",
  financePolicyRules: "Uitgavenbeleid",
  financePolicyRulesHint: (currency: string) => `Drempels zijn uitgedrukt in de boekhoudvaluta ${currency}.`,
  financeReceiptRule: "Bon verplichten",
  financeReceiptRuleHint: "Declaraties vanaf dit bedrag kunnen zonder bijgevoegde bon niet worden goedgekeurd.",
  financeProjectRule: "Project verplichten",
  financeProjectRuleHint: "Declaraties vanaf dit bedrag moeten vóór goedkeuring aan een opdracht zijn gekoppeld.",
  financeSecondApprovalRule: "Twee goedkeurders verplichten",
  financeSecondApprovalRuleHint: "Hoge bedragen blijven ingediend tot twee verschillende financiële goedkeurders instemmen.",
  ...
  financeApprovalRecorded: (count: number, required: number) => `Goedkeuring ${count} van ${required} vastgelegd. Een andere goedkeurder moet afronden.`,
  financeApprovalProgress: (count: number, required: number) => `${count} van ${required} goedkeuringen`,
