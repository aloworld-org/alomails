...
mod tests {
    ...
    fn every_read_runs_and_every_write_waits() {
        ...
        // Fifty of them, which is the whole point of ADR 0047 — eleven
        ...
        // agent's six intent reads (A4.1), the Sales agent's four (AA.1) and
        // the Chat agent's three new intent reads (AC.1); the folder, the
        // rename, the move, the reschedule, the priority, the chase, the
        // capture, the minutes and the room post are writes and are counted
        // on the other side.
