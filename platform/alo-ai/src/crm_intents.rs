...
pub const CRM_INTENTS: &[IntentSpec] = &[
    ...
    IntentSpec {
        ...
        answers: &[
            "where are we with the X deal",
            "what is the status of X",
            "when did X move stage",
            "what happened on X lately",
        ],
        preview: None,
        undo: None,
        routes: &[
    ...
    IntentSpec {
        ...
        answers: &[
            "where are we with company X",
            "have we spoken to X before",
            "what deals have we had with X",
            "what have we done with X lately",
        ],
        preview: None,
        undo: None,
