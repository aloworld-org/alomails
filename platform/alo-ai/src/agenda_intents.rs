...
pub const AGENDA_INTENTS: &[IntentSpec] = &[
    ...
    IntentSpec {
        ...
        answers: &[
            ...
            "when can {people} and I meet for an hour this week",
        ],
        preview: None,
        undo: None,
        routes: &[],
    ...
    IntentSpec {
        ...
        answers: &["what do I need for {meeting}"],
        preview: None,
        undo: None,
        routes: &[],
    },
    IntentSpec {
        ...
        effect: Effect::Read,
        args: &[MEETING_ARG, ON_ARG],
        answers: &["when is {meeting}", "who has replied to {meeting}"],
        preview: None,
        undo: None,
    ...
    IntentSpec {
        ...
        answers: &[
            "is {person} free tomorrow at two",
            "what does {person} have on Friday morning",
        ],
        preview: None,
        undo: None,
        routes: &[],
    ...
    IntentSpec {
        ...
        answers: &["move {meeting} to Thursday at 2"],
        preview: Some(
    ...
    IntentSpec {
        ...
        effect: Effect::Write,
        args: &[MEETING_ARG, ON_ARG],
        answers: &["cancel {meeting}", "call off {meeting}"],
        preview: Some(
