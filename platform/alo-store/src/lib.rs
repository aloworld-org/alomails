...
pub mod crm_deal_documents;
pub mod crm_deal_projects;
...
pub use billing_invoice_designs::InvoiceDesignRecord;
...
pub use crm_deal_documents::DealBillingDocument;
pub use crm_deal_projects::DealProject;
